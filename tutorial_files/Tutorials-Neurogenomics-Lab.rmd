---
title: "Performing Peak Calling on TIP-seq Data"
editor_options: 
  markdown: 
    wrap: 72
---
...
1.  **Mount the RDS on your local machine.**
    ...
    CMD+K](img_connect_to_server.png){width="430"}
    ...
    **username** with your Imperial username:
    ...
    <center>[**smb://rds.imperial.ac.uk/RDS/user/username**](smb://rds.imperial.ac.uk/RDS/user/username){.uri}</center>
...
2.  **Navigate to the experiment folder.**
    ...
    *tipseq_14_01_nov_2022* experiment.
    ...
    linear_duplicates
    subdirectory.](img_find_bam_files.png){width="430"}
...
2.  **Run the MACSr `callpeak` command.**
    ...
    <center>![](img_peak_files.png){width="440"}</center>
    ...
    <center>![](img_narrowpeak_file_content.png){width="600"}</center>
...
2.  **Loading peak files into IGV.**
    ...
    build](img_igv_genome_selection.png){width="500"}
    ...
    <center>![](img_igv_load_from_file.png){width="400"}</center>
...
3.  **Loading BAM files into IGV.**
    ...
    <center>![](img_drag_and_drop_bam_file.png){width="400"}</center>
